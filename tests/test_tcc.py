...
class TCCMixin:
    ...
    def test_dispatch(self):
        with self.kitchen_class() as kitchen:
            ...
            kitchen.pantry.fill(kitchen.recipes, path=self.get_sample_path("tcc", 12))
            ...
            mgrib_args_prefix = "INFO:arkimaps.order.tcc+012:add_grib mgrib "
            mgrib_args = None
            for l in log.output:
            ...
            self.assertEqual(os.path.basename(orders[0].output), "tcc+012.png")
