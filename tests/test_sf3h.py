...
@recipe_tests("sf3h", models=["Cosmo"])
    ...
    def test_process(self):
        ...
        self.assertProcessLogEqual(
            [
                ...
                f" snowsum_2021_1_10_0_0_0+{step}.grib"
                for step in range(0, 13)
            ]
            + [
...
class SF3HNoConvMixin:
    def test_process(self):
        ...
        pantry_reftime = "2021_1_10_0_0_0"
        self.fill_pantry(
            expected=[f"{self.model_name}_snowgsp_{pantry_reftime}+{step}.grib" for step in range(0, 13)],
            exclude="*_snowcon_*",
        )
