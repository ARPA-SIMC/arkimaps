...
* **z700**:
    * Model **cosmo**:
        ...
        * **grib_filter matcher**: `shortName is "z" and indicatorOfTypeOfLevel == 100 and level == 700 and centre != 98`
        * **mgrib {k}**: `False`
        * **mgrib {k}**: `0.01`
    * Model **ifs**:
        * **Arkimet matcher**: `product:GRIB1,98,128,156; level:GRIB1,100,700`
        * **grib_filter matcher**: `shortName is "gh" and indicatorOfTypeOfLevel == 100 and level == 700 and centre == 98`
        * **mgrib {k}**: `False`
        * **mgrib {k}**: `0.1`
* **uv700**:
    * **Preprocessing**: cat
