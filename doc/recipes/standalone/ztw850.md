# standalone/ztw850: Temperature and Geopotential at 850hPa
...
* **z850**:
    * Model **cosmo**:
        ...
        * **grib_filter matcher**: `shortName is "z" and levelType == 100 and level == 850 and centre != 98 and editionNumber == 1`
    * Model **ifs**:
        ...
        * **mgrib {k}**: `0.1`
    * Model **icon**:
        * **Arkimet matcher**: `product:GRIB2,,,003,004,,;level:GRIB2S,100,000,0000085000`
        * **grib_filter matcher**: `shortName is "z" and levelType == 100 and level == 850 and centre != 98 and editionNumber == 2`
    * Model **wrf**:
        * **Arkimet matcher**: `product:GRIB2,,,003,005,,;level:GRIB2S,100,000,0000085000`
        * **grib_filter matcher**: `centre != 98 and shortName is "gh" and typeOfLevel is "isobaricInhPa" and level == 850 and editionNumber == 2`
        * **mgrib {k}**: `False`
        * **mgrib {k}**: `0.1`
* **uv850**:
    * **Preprocessing**: cat
