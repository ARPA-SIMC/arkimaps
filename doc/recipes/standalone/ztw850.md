...
* **z850**:
    * Model **cosmo**:
        ...
        * **grib_filter matcher**: `shortName is "z" and indicatorOfTypeOfLevel == 100 and level == 850 and centre != 98`
    * Model **ifs**:
        * **Arkimet matcher**: `product:GRIB1,98,128,156; level:GRIB1,100,850`
        * **grib_filter matcher**: `shortName is "gh" and indicatorOfTypeOfLevel == 100 and level == 850 and centre == 98`
        * **mgrib {k}**: `False`
        * **mgrib {k}**: `0.1`
    * Model **wrf**:
        * **Arkimet matcher**: `product:GRIB2,,000,003,005,002,001;level:GRIB2S,100,000,0000085000`
