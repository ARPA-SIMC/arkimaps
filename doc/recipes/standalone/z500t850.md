# standalone/z500t850: Temperature and Geopotential at 500hPa
...
* **z500**:
    * Model **cosmo**:
        ...
        * **grib_filter matcher**: `shortName is "z" and levelType == 100 and level == 500 and centre != 98 and editionNumber == 1`
    * Model **ifs**:
        * **Arkimet matcher**: `product:GRIB1,98,128,156; level:GRIB1,100,500`
        * **grib_filter matcher**: `shortName is "gh" and levelType == 100 and level == 500 and centre == 98`
        * **mgrib {k}**: `False`
        * **mgrib {k}**: `0.1`
    * Model **icon**:
        * **Arkimet matcher**: `product:GRIB2,,,003,004,,;level:GRIB2S,100,000,0000050000`
        * **grib_filter matcher**: `shortName is "z" and levelType == 100 and level == 500 and centre != 98 and editionNumber == 2`
    * Model **wrf**:
        * **Arkimet matcher**: `product:GRIB2,,,003,005,,;level:GRIB2S,100,000,0000050000`
        * **grib_filter matcher**: `centre != 98 and shortName is "gh" and typeOfLevel is "isobaricInhPa" and level == 500 and editionNumber == 2`
        * **mgrib {k}**: `False`
        * **mgrib {k}**: `0.1`
